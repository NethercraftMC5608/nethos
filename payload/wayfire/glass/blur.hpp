...
class nethos_glass_base
{
  protected:
    ...
    /* the program used by nethos_glass_base to combine the blurred, unblurred and
     * view texture */
    ...
    wf::option_wrapper_t<double> refraction_opt, rim_opt;
  ...
  public:
    nethos_glass_base(std::string name);
    virtual ~nethos_glass_base();
...
std::unique_ptr<nethos_glass_base> create_nethos_glass(std::string algorithm_name);
